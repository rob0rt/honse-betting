...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchema": "generator client {\n  provider   = \"prisma-client\"\n  output     = \"../src/lib/prisma\"\n  engineType = \"client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id       String  @id\n  username String\n  avatar   String?\n  balance  Int     @default(0)\n  admin    Boolean @default(false)\n  bets     Bet[]\n}\n\nmodel Race {\n  id     Int         @id @default(autoincrement())\n  date   DateTime\n  bets   Bet[]\n  horses RaceHorse[]\n}\n\nmodel Horse {\n  id    Int         @id @default(autoincrement())\n  name  String\n  races RaceHorse[]\n}\n\nmodel RaceHorse {\n  raceId       Int\n  horseId      Int\n  saddleNumber Int\n  place        Int?\n\n  race  Race  @relation(fields: [raceId], references: [id])\n  horse Horse @relation(fields: [horseId], references: [id])\n\n  @@id([raceId, horseId])\n  @@unique([raceId, saddleNumber])\n  @@index(raceId)\n}\n\nenum BetType {\n  WIN\n  PLACE\n  SHOW\n  EXACTA\n  TRIFECTA\n}\n\nmodel Bet {\n  id     Int @id @default(autoincrement())\n  amount Int\n\n  userId String\n  raceId Int\n\n  type BetType\n  data Json\n\n  user User @relation(fields: [userId], references: [id])\n  race Race @relation(fields: [raceId], references: [id])\n}\n",
  "inlineSchemaHash": "aea20f3c972a9a885ce52054d5e28d5e5244732561bb06cc20c896cfd2cef311",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
